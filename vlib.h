...
C_RESULT inline video_peek_data( const video_stream_t* const stream, uint32_t* code, int32_t length );
...
//      "=r" (value):
//      "0" (value));
    value=((value&(unsigned int)0xff)<<24)
    |((value&(unsigned int)0xff00)<<8)
    |((value&(unsigned int)0xff0000)>>8)
